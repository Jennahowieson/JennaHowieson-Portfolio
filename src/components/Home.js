    ...
    <div>
        ...
        <section id='skills-box'>
            ...
            <ul>
                ...
                <li><i class="devicon-react-plain-wordmark "></i></li>
                ...
                <li><i class="devicon-flask-plain-wordmark "></i></li>
                <li><i class="devicon-java-plain-wordmark "></i></li>
                <li><i class="devicon-wordpress-plain-wordmark "></i></li>
                <li><i class="devicon-canva-original "></i></li>
